...
import 'package:shopmart_admin/consts/app_constants.dart';
import 'package:shopmart_admin/models/product_model.dart';
import 'package:shopmart_admin/screens/search_screen.dart';
import 'package:shopmart_admin/services/my_app_functions.dart';
import 'package:shopmart_admin/services/product_service.dart';
  ...
  Future<void> _editProduct() async {
    ...
    if (isValid) {
      try {
        ...
        // if (_pickedImage != null) {
        //   final ref = FirebaseStorage.instance.ref().child("productsImages").child(
        //       "${widget.productModel!.productTitle}_${widget.productModel!.productId}.jpg");
